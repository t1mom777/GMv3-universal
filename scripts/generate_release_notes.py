...
def _render(version: str, checksums: list[tuple[str, str]]) -> str:
    ...
    lines.append("- Self-contained installer assets (runtime + dependencies + bundled Codex CLI).")
    ...
    lines.append("- Codex auth can be completed from installer flow (browser login via bundled `codex login`).")
    lines.append("")
    lines.append("## Notes")
